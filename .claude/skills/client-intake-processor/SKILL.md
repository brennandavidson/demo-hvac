...
8. **Process images with Freepik API** (blog images, service area images, project photos)
9. Test build

⚠️ **CRITICAL: Step 8 is MANDATORY.** You MUST call the Freepik API to get images for blog posts and service areas. Do NOT use Unsplash URLs. Do NOT skip Step 8. The Freepik commands are in Step 8 - execute them.
...
---
## Step 8: Process Images with Freepik API

⚠️ **DO NOT SKIP THIS STEP. You MUST call the Freepik API for blog and city images.**
...
### 8.1: Blog Images (REQUIRED - use Freepik API)
...
### 8.2: Service Area Images (REQUIRED - use Freepik API)
...
### 8.3: Project Gallery Images (client photos ONLY)
